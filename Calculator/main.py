...
buttonp2 = Button(root, text=')', padx=40, pady=40, command=lambda: button_secondp(')'))
...
buttonsqr.grid(row=2, column=4)
buttonp1.grid(row=3, column=4)
buttonp2.grid(row=4, column=4)
